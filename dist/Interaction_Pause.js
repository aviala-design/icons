    ...
    "paths": [
      {
        ...
        export function getInteraction_Pause(mode = 'outline') {
            return Interaction_PauseIcon[mode] || Interaction_PauseIcon['outline'];
        }
        
        export const Interaction_PauseModes = Object.keys(Interaction_PauseIcon);
        
        // 导出图标数据本身
        export const Interaction_Pause = Interaction_PauseIcon;